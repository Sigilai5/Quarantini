...
class _EditProfileState extends State<EditProfile> {
  final _scaffoldKey = GlobalKey<ScaffoldState>(); //For Snack Bar
  ...
  updateProfileData(){
      setState(() {
        ...
        displayBioController.text.trim().length > 100 ? _bioValid = false: _bioValid = true;
      });
...
//        leading: IconButton(
//            icon: GestureDetector(child: Icon(Icons.cancel, color: Colors.black,), onTap: profilePage,),
//            onPressed: profilePage),
        ...
        actions: <Widget>[
          IconButton(icon: Icon(Icons.done,size: 30.0,color: Colors.green,),
