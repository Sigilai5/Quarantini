...
class _CreateAccountState extends State<CreateAccount> {
  ...
  final _formKey = GlobalKey<FormState>(); //Responsible for executing onSave as well as getting the current state of our form
  String username;
            ...
            child: Column(children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                  child: Form(
                    key: _formKey,
                    autovalidate: true, //validate in real time
                    child: TextFormField(
                      validator: (val){
